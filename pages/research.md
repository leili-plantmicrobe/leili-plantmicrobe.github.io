...
![colleto]({{ site.baseurl }}{% link /assets/img/colleto.jpg %}){: .rounded .float-right}
...
![pheno]({{ site.baseurl }}{% link /assets/img/pheno.png %}){: .rounded .float-right}
...
![tree]({{ site.baseurl }}{% link /assets/img/tree.jpg %}){: .rounded .float-right}
